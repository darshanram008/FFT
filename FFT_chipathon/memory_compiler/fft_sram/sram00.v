...
//      Test Muxes                  Off
//
//      Creation Date:  Fri Jun  5 11:39:05 2026
//      Version: 	r0p0-00eac0
//
...
`endif
  ...
  begin
    if (RETN_int === 1'bx) begin
      ...
      writeEnable = ~( {32{GWEN_int}} | {WEN_int[4], WEN_int[4], WEN_int[4], WEN_int[4],
         WEN_int[3], WEN_int[3], WEN_int[3], WEN_int[3], WEN_int[3], WEN_int[3], WEN_int[3],
         WEN_int[2], WEN_int[2], WEN_int[2], WEN_int[2], WEN_int[2], WEN_int[2], WEN_int[2],
         WEN_int[1], WEN_int[1], WEN_int[1], WEN_int[1], WEN_int[1], WEN_int[1], WEN_int[1],
...
`endif
  ...
  reg NOT_D3, NOT_D30, NOT_D31, NOT_D4, NOT_D5, NOT_D6, NOT_D7, NOT_D8, NOT_D9, NOT_EMA0;
  reg NOT_EMA1, NOT_EMA2, NOT_GWEN, NOT_RETN, NOT_WEN0, NOT_WEN1, NOT_WEN2, NOT_WEN3;
  reg NOT_WEN4;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
...
`endif
  ...
  assign D_flag14 = !(CEN_ || WEN_[2] || GWEN_);
  assign D_flag15 = !(CEN_ || WEN_[2] || GWEN_);
  ...
  assign D_flag21 = !(CEN_ || WEN_[3] || GWEN_);
  assign D_flag22 = !(CEN_ || WEN_[3] || GWEN_);
  assign D_flag23 = !(CEN_ || WEN_[3] || GWEN_);
  ...
  assign D_flag28 = !(CEN_ || WEN_[4] || GWEN_);
  assign D_flag29 = !(CEN_ || WEN_[4] || GWEN_);
  assign D_flag30 = !(CEN_ || WEN_[4] || GWEN_);
  assign D_flag31 = !(CEN_ || WEN_[4] || GWEN_);
