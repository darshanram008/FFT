...
module fft_top_synth #(
    ...
    // through the address_gen to produce tb_bitrev_addr.
     fft_address_gen_FFT_POINT128  u_addr(
        .stage        (stage),
        .group        (group),
        .bfly         (bfly),
    ...
    // Controller
    // --------------------------------------------------------------------
    fft_controller_DATA_WIDTH16_FFT_POINT128  u_ctrl(
        .clk          (clk),
        .rstn         (rstn),
        .start        (start),
    ...
    // Data SRAM
    // --------------------------------------------------------------------
    fft_datafft_data_sram_FFT_POINT128_sram  u_data_sram(
        .clk       (clk),
        .tb_sel    (sram_tb_sel),
    ...
    // Twiddle SRAM
    // --------------------------------------------------------------------
    fft_twiddle_sram_FFT_POINT128 u_tw_sram(
        .clk       (clk),
        .tb_sel    (sram_tb_sel),
