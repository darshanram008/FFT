...
module fft_controller (
    ...
    output reg [31:0]  core_x0,
    output reg [31:0]  core_x1,
    output reg [31:0]  core_w,
    input      [31:0]  core_x0_out,
    input      [31:0]  core_x1_out,
    ...
    // Registers
    reg [31:0] x0_latched;        // x0 data sample, captured in S_READ_X1
    reg [9:0]  x0_addr_l;         // x0 physical address (for WB0)
    reg [9:0]  x1_addr_l;         // x1 physical address (for WB1)
    ...
    wire [9:0]  distance_w   = 10'd1 << stage;
    wire [10:0] num_groups_w = 11'd1024 >> (stage + 4'd1);

    wire last_bfly_in_group  = ({1'b0, bfly}   + 10'd1 == distance_w);
    wire last_group_in_stage = ({2'b00, group} + 11'd1 == num_groups_w);
    wire last_stage          = (stage == 4'd9);
    wire last_butterfly      = last_bfly_in_group & last_group_in_stage & last_stage;
